...
class NamingOverrides:
    ...
    def _save_data(self) -> None:
        ...
        try:
            ...
            logger.info(f"Overrides gespeichert: {len(self.data['entities'])} entities, {len(self.data['devices'])} devices")
        except Exception as e:
    ...
    def set_entity_override(self, registry_id: str, name: str, type_override: Optional[str] = None) -> None:
        ...
        self.data["entities"][registry_id] = {
            "name": name
        }
        if type_override:
