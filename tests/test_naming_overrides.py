...
class TestNamingOverrides:
    ...
    def test_get_area_override(self):
        ...
        overrides = NamingOverrides()
        overrides._overrides = {"areas": {"area1": {"name": "Custom Area"}}}
    ...
    def test_get_device_override(self):
        ...
        overrides = NamingOverrides()
        overrides._overrides = {"devices": {"device1": {"name": "Custom Device"}}}
    ...
    def test_get_entity_override(self):
        ...
        overrides = NamingOverrides()
        overrides._overrides = {"entities": {"entity1": {"name": "Custom Entity"}}}
